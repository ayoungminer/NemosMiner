...
$PlusPath = ((split-path -parent (get-item $script:MyInvocation.MyCommand.Path).Directory) + "\BrainPlus\blockmastersplus\blockmastersplus.json")
Try {
    $blockmasters_Request = get-content $PlusPath | ConvertFrom-Json 
}
catch { return }
