...
powershell -version 5.0 -noexit -executionpolicy bypass -windowstyle Normal -command "&.\EarningsTrackerJob.ps1 -Pool zergpool -Wallet 3FJxLvN1XTjN5zH78YMVDdPSNrTzN44DeB -APIUri http://api.zergpool.com:8080/api/walletEx?address=
