...
$Uri = "https://github.com/ayoungminer/miner-bin/raw/master/NVIDIA-ccminerenemy/NVIDIA-ccminerenemy.zip"
...
$Commands = [PSCustomObject]@{
    ...
    #"x17" = " -d $SelGPUCC --api-remote -N 3" #X17
    #"x16r" = " -d $SelGPUCC --api-remote -N 6" #X16r
